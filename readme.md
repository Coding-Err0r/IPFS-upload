...
<div align="center">
  ...
  <h3 align="center">IPFS Upload</h3>

  <p align="center">
    A javascript that uploads files to UPFS and then publishes in blockchain.
    <br />
    <br />
...
This project is to show how to upload files to IPFS for free and publish them in ethereum blockchain using smart contract.
...
1. Clone repo
   ```sh
   git clone https://github.com/Coding-Err0r/IPFS-upload.git
   ```
...
Project Link: [Porject Link](https://github.com/Coding-Err0r/IPFS-upload.git)
